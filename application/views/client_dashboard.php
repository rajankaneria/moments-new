<div class="container">
 ...
 <div class="card-panel">
  <div class="page-header row">
      <div class="page-title col s8 m10">Client Logo Management</div>      
      <div class="page-button col s4 m2"><a class="waves-effect waves-light btn blue" id="addClientBtn">Add</a></div>
  </div>
